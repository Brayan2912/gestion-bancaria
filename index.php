...
<head>
   ...
   </script><title>Bank</title>

  <link rel="icon" type="image/png" href="imagenes/tarjeta.png" />
...
<div id="modal-wrapper" class="modal">
  ...
  <form class="modal-content animate" action="bancovalida.php" method="POST">
    ...
    <div class="imgcontainer">
      ...
      <img src="imagenes/tarjeta.png" width="200" alt="LikeFans" class="LikeFans">
      ...
      <div class="row">
        <div class="col-12">
            <div class="my-3 p-3 bg-white rounded box-shadow box-style">
                <div id="home-box">
                    <div class="content">
                        <h1 style="font-size:x-large; color:black; ">BANK</h1>
                        <p class="mt-3 text-left"><img src="imagenes/tarjeta.png" width="500" class="img-fluid float-left" alt="LikeFans" > <h5 style="color:black; ">
...
<div class="row">
<div class="col">
<a class="nav-link" onclick="document.getElementById('modal-wrapper').style.display='block'"><button class="btn btn-warning">INGRESAR BANK</button></a>
</div>
<div class="col">
<a class="nav-link" onclick="document.getElementById('modal2-wrapper').style.display='block'"><button class="btn btn-warning">REGISTRARSE BANK</button></a>
</div>
 </div>
